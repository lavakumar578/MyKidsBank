...
public class MakeADepositIntoOneOrMoreAccountsPage {
	...
	public MakeADepositIntoOneOrMoreAccountsPage(WebDriver driver)
	{
		PageFactory.initElements(driver, this);
	}
	
	public void makeADepositToAllAccounts(String description,String amount) {
		this.enterDescription.sendKeys(description);
		this.enterAmount.sendKeys(amount);
		this.selectAllBtn.click();
		this.submitBtn.click();
	}
	public void makeADeposit(String description,String amount)
	{
		this.enterDescription.sendKeys(description);
		this.enterAmount.sendKeys(amount);
		this.nAccount.click();
