...
public class SetAutomaticWithdrawalPage {
	...
	@FindBy(xpath="//input[@title=\"Enter amount to withdraw\"]")
	...
	public SetAutomaticWithdrawalPage(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}
	public void setAutomaticWithdraw(String amount,String description) {
